-- Ocultar notificación por usuario (globales y personales) sin borrar la fila global.
...
REVOKE ALL ON TABLE public.arcusx_notification_dismissals FROM PUBLIC;
GRANT ALL ON TABLE public.arcusx_notification_dismissals TO postgres;
...
GRANT EXECUTE ON FUNCTION public.arcusx_dismiss_notification(bigint) TO authenticated;
