  ...
  const tutorials: Tutorial[] = [
    {
      ...
      title: {
        ...
        pt: 'Introdução ao Stellar e carteiras'
      },
      description: {
        ...
        pt: 'Saiba o que é a Stellar, como funciona a blockchain e quais carteiras pode usar. Conheça a Freighter e outras opções para gerir os seus ativos digitais.'
      },
    ...
    },
    {
      ...
      description: {
        ...
        pt: 'Saiba o que é a ArcusX, como funciona a plataforma, o que pode fazer como cliente ou freelancer e os conceitos básicos para começar.'
      },
    ...
    },
    {
      ...
      title: {
        ...
        pt: 'Como ligar a sua carteira Freighter'
      },
      description: {
        ...
        pt: 'Aprenda a ligar a carteira Freighter à plataforma ArcusX de forma rápida e simples.'
      },
    ...
    },
    {
      ...
      title: {
        ...
        pt: 'Como criar a sua primeira tarefa'
      },
      description: {
        ...
        pt: 'Guia completo para publicar a sua primeira tarefa na ArcusX: orçamento, descrição, categorias e o necessário para encontrar o freelancer ideal.'
      },
    ...
    },
    {
      ...
      title: {
        ...
        pt: 'Como candidatar-se a uma tarefa'
      },
      description: {
        ...
        pt: 'Aprenda a candidatar-se como freelancer: proposta convincente, portfólio e mais hipóteses de ser selecionado.'
      },
    ...
    },
    {
      ...
      title: {
        ...
        pt: 'Escolher o freelancer ideal, aprovar e financiar a tarefa'
      },
      description: {
        ...
        pt: 'Como funciona o escrow na ArcusX: financiar a tarefa e libertar pagamentos com segurança.'
      },
    ...
    },
    {
      ...
      title: {
        ...
        pt: 'Supervisionar e concluir tarefas'
      },
      description: {
        ...
        pt: 'Comunique-se com o freelancer, reveja entregas e conclua a tarefa com sucesso.'
      },
    ...
    },
    {
      ...
      title: {
        ...
        pt: 'Como usar o swap da plataforma'
      },
      description: {
        ...
        pt: 'Troque XLM e USDC com rapidez e segurança com o swap integrado na ArcusX.'
      },
            ...
            <div className="tutorial-thumbnail">
              <img
                ...
                onError={(e) => {
                  ...
                  target.src =
                    'https://via.placeholder.com/640x360/0a0a0a/10dd88?text=ArcusX+Tutorial';
                }}
              />
