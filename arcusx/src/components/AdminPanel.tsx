...
const AdminPanel: React.FC<AdminPanelProps> = ({ isAdmin }) => {
  ...
  const fetchAdminStats = async () => {
    ...
    try {
      ...
      // platform_fee en BD es decimal (0.017 = 1.7% ArcusX; +0.3% op = 2% trabajador)
      ...
      const platformFeeDisplay = typeof platformFeeValue === 'number'
        ...
        : (typeof platformFeeValue === 'string' ? parseFloat(platformFeeValue) * 100 : 1.7);
      ...
      setStats({
        ...
        platformFee: platformFeeDisplay || 1.7,
